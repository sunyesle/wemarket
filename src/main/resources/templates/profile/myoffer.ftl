...
<div class="container" id="profileMyoffer" v-cloak>
  <!-- 탭 -->
  <div class="nav nav-pills nav-fill mx--2 px-lg-6 mt-3 mb-0 mb-sm-3">
    ...
    <div class="nav-item col-4 col-sm-2 px-2">
      <a class="nav-link px-0 active pointer">내제안</a>
    </div>
    <div class="nav-item col-4 col-sm-2 px-2">
            ...
            <li class="list-group-item px-0" v-for="(offer, index) in offerOpen.list" v-bind:key="offer.id">
              <div class="row">
                <div class="col">
                  ...
                  <span class="badge badge-success mr-1" v-if="offer.status === 'TRADE'">거래중</span>
                  <span class="badge badge-default mr-1" v-else-if="offer.status === 'COMPLETED'">거래완료</span>
...
<script src="${rc.getContextPath()}/static/js/profile/myoffer.js"></script>
